...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       // let apiUrl = "http://www.mocky.io/v2/5c39d52b2f00006200b5dbbd"//[User].self
        let apiUrl = "http://www.mocky.io/v2/5c39dd3c2f00005300b5dbc5"
        UtilityClass.sharedInstance.requestGetFor(reqUrl: apiUrl, viewLoader: self.tableView, viewContLoader: self) { (dataResponse) in
